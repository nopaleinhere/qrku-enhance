...
private fun supportFormat(format: Int?): ZFormat? {
    return when (format) {
        ...
        BarcodeType.Support.PLAY_STORE.format,
        BarcodeType.Support.CALENDAR.format,
        BarcodeType.Support.CONTACT.format,
        BarcodeType.Support.EMAIL.format,
        BarcodeType.Support.PHONE.format,
        BarcodeType.Support.VCARD.format,
        BarcodeType.Support.WIFI.format,
        BarcodeType.Support.MESSAGE.format,
